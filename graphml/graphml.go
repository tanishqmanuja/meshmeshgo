...
// From project https://github.com/yaricom/goGraphML
...
func (gr *Graph) AddNode(attributes map[string]interface{}, nodeId string, description string) (node *Node, err error) {
	id := nodeId
	if len(id) == 0 {
		id = gr.nextNodeId()
	}
